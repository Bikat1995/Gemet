...
await call(token,'setMyCommands',{commands:[{command:'start',description:'Open Gemet auctions'},{command:'auctions',description:'View live auctions'},{command:'wallet',description:'Open wallet'}]});
if(apiUrl){
